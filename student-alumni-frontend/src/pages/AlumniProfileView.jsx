  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        // ✅ Fix image path if backend sends relative uploads path
        if (res.data.profilePicture && !res.data.profilePicture.startsWith("http")) {
          res.data.profilePicture = `${import.meta.env.VITE_API_BASE_URL}/${res.data.profilePicture}`;
        }
