...
const AlumniProfile = () => {
      ...
      try {
        ...
        if (res.data) {
          ...
          if (res.data.profilePicture) {
            setPreviewImage(`${import.meta.env.VITE_API_BASE_URL}/${res.data.profilePicture}`);
          }
        }
      } catch (err) {
  ...
  const addDegree = () => {
    setFormData({
      ...formData,
      degrees: [...formData.degrees, { degree: '', specialization: '', institute: '', batch: '' }],
    });
  };
      ...
      Object.keys(formData).forEach((key) => {
        if (key === 'location') {
          ...
          formData.degrees.forEach((deg, idx) => {
            ...
            formToSend.append(`degrees[${idx}][specialization]`, deg.specialization);
